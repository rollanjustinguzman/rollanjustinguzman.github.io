/* ============================================================
   ...
   Animations run for every visitor. If the scripts ever fail to
   load, the page falls back to showing everything, unanimated.
   ============================================================ */
...
(function () {
  ...
  function buildIntro() {
    ...
    intro
      ...
      .to(counter, {
        v: 100, duration: 1.2 * fast, ease: 'power2.inOut',
    ...
    Promise.all([imgReady, new Promise(function (r) { intro.eventCallback('onComplete', r); })]).then(function () {
      ...
      var unlock = function () {  // scrolling is allowed as soon as the curtain has lifted
      ...
      out
        ...
        .to(loader, { clipPath: 'inset(0 0 100% 0)', duration: 1.1, ease: 'expo.inOut', onComplete: unlock }, '-=0.15')
