...
**Reduced motion.** If a visitor has "reduce motion" turned on in their phone or computer settings,
the preloader, smooth scroll and text effects are skipped automatically and everything simply shows.
The same happens if JavaScript is off.
